...
def setup_logging(level: str = "INFO", log_dir: str = "data/logs", json_mode: bool = False) -> None:
    """初始化全局日志"""
    ...
    file_h = logging.handlers.RotatingFileHandler(
        log_path / "gateway.log", maxBytes=20 * 1024 * 1024, backupCount=5, encoding="utf-8"
    )
...
class Metrics:
    ...
    _instance: Metrics = None  # type: ignore[assignment]
