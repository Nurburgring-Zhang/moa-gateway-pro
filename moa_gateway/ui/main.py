...
def main(page: ft.Page):
    ...
    status_bar = ft.Container(
        content=ft.Row(
            controls=[status_time, ft.Container(expand=True),
                       status_dot, status_text, ft.VerticalDivider(width=1, color=DARK.border),
                       status_theme_picker, start_btn],
            alignment=ft.MainAxisAlignment.SPACE_BETWEEN,
        ),
        bgcolor=DARK.surface, height=38, padding=ft.padding.symmetric(horizontal=16),
    ...
    def make_nav_item(key: str, icon: str, text: str):
        btn = ft.Container(
            ...
            border_radius=10,
            ink=True, on_click=lambda _, k=key: switch_page(k),
    ...
    sidebar = ft.Container(
                ...
                ft.Container(
                    content=ft.Column(
                        controls=[
                            ...
                            ft.Text("MULTI-MODEL ORCHESTRATION", size=10,
                                    color=DARK.text_dim, weight=ft.FontWeight.W_500),
                        ], spacing=2,
                    ),
        ...
        bgcolor=DARK.surface, width=240,
    ...
    def rebuild_ui():
        ...
        if state["current_page"] in page_views:
            page_views[state["current_page"]] = build_pages[state["current_page"]](state, server_runner)
