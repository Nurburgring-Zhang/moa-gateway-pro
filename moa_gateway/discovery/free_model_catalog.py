...
FreeTierType = Literal["permanent", "signup_credits", "anonymous", "freemium", "free", "trial", "trial_credits"]
...
_PLATFORMS: list[PlatformInfo] = [
    # ==================== Overseas platforms (17 active, 1 deprecated) ====================
    PlatformInfo(
        platform_id="gemini",
        platform_name="Google Gemini",
        base_url="https://generativelanguage.googleapis.com/v1beta",
        api_format="google_gemini",
        auth_type="query_param",
        signup_url="https://aistudio.google.com/apikey",
        free_tier_type="freemium",
    ...
    PlatformInfo(
        platform_id="nvidia_nim",
        platform_name="NVIDIA NIM",
        base_url="https://integrate.api.nvidia.com/v1",
        api_format="openai",
        auth_type="bearer",
        signup_url="https://build.nvidia.com",
        free_tier_type="signup_credits",
        models_endpoint="/models",
        rate_limit_info="40 RPM, 1000 calls/month",
        region="overseas",
    ),
    PlatformInfo(
        platform_id="cloudflare_ai",
        platform_name="Cloudflare AI",
    ...
    PlatformInfo(
        platform_id="github_models",
        platform_name="GitHub Models",
    ...
    # [DEPRECATED 2026-02] Chutes AI — free tier discontinued, removed from active catalog.
    # PlatformInfo(
    #     platform_id="chutes",
    #     platform_name="Chutes AI",
    ...
    PlatformInfo(
        ...
        free_tier_type="signup_credits",
        models_endpoint="/models",
        rate_limit_info="60 RPM, 10000 RPD ($1 startup credits)",
        region="overseas",
    ),
    PlatformInfo(
        platform_id="aimlapi",
        platform_name="AIML API",
        ...
        free_tier_type="signup_credits",
        models_endpoint="/models",
        rate_limit_info="30 RPM, 5000 RPD (600+ models aggregator)",
        region="overseas",
    ),
    PlatformInfo(
        platform_id="novita",
        ...
        free_tier_type="signup_credits",
        models_endpoint="/models",
        rate_limit_info="60 RPM, 10000 RPD ($0.50 signup credits)",
        region="overseas",
    ),
    PlatformInfo(
        ...
        rate_limit_info="50 RPM, 5000 RPD ($5 one-time credits)",
        region="overseas",
    ),
    # ==================== Domestic: AI Model Companies ====================
    PlatformInfo(
        platform_id="zhipu",
        platform_name="Zhipu AI (GLM)",
    ...
    PlatformInfo(
        platform_id="qwen",
        platform_name="Qwen (Tongyi Qianwen)",
    ...
    PlatformInfo(
        platform_id="hw_pangu",
        platform_name="Huawei Pangu",
    ...
    PlatformInfo(
        platform_id="doubao",
        platform_name="ByteDance Doubao",
    ...
    PlatformInfo(
        platform_id="sensetime",
        platform_name="SenseTime SenseNova",
    ...
    PlatformInfo(
        platform_id="tiangong",
        platform_name="Kunlun Tiangong",
    ...
    PlatformInfo(
        platform_id="china_mobile_wuyan",
        platform_name="China Mobile Wuyan",
    ...
    PlatformInfo(
        platform_id="china_telecom_xingchen",
        platform_name="China Telecom Xingchen",
    ...
    PlatformInfo(
        platform_id="china_unicom_yuanjing",
        platform_name="China Unicom Yuanjing",
    ...
    PlatformInfo(
        platform_id="minimax_music",
        platform_name="MiniMax Music",
        base_url="https://api.minimax.chat/v1",
        api_format="custom",
        auth_type="bearer",
        signup_url="https://platform.minimaxi.com",
    ...
    PlatformInfo(
        platform_id="tiangong_music",
        platform_name="Tiangong SkyMusic",
        base_url="https://api.tiangong.cn/v1",
        api_format="custom",
        auth_type="bearer",
        signup_url="https://platform.tiangong.cn",
