...
_MINIMAL_KEYWORDS = frozenset({
    "fix", "bug", "typo", "small", "tiny", "trivial", "hotfix",
    "patch", "rename", "format", "lint", "comment", "docs-fix",
})

# THOROUGH 触发词
_THOROUGH_KEYWORDS = frozenset({
    "design", "architecture", "refactor", "redesign", "migrate",
    "overhaul", "restructure", "rewrite", "investigate", "research",
    "explore", "audit", "analyze", "plan", "strategy",
})
