...
# imperative 触发短语 (英文)
IMPERATIVE_PHRASES = (
    "please", "show me", "give me", "write", "create", "generate",
    "list", "explain", "describe", "summarize", "translate",
    "compute", "calculate", "solve", "implement", "refactor",
    "fix", "debug", "build", "design", "draft", "compose",
    "请你", "请", "帮我", "写一下", "写个", "给出", "列出", "解释一下",
)

# 否定词
NEGATION_WORDS = frozenset({
    "not", "no", "never", "don't", "won't", "wouldn't", "shouldn't",
...
HEDGING_WORDS = frozenset({
    ...
    "likely", "seems", "appears", "somewhat", "roughly", "about",
    "也许", "可能", "大概", "或许", "似乎", "差不多",
})
...
POSITIVE_WORDS = frozenset({
    ...
    "fantastic", "love", "best", "happy", "nice", "awesome",
    "好", "棒", "完美", "优秀", "喜欢", "开心", "满意",
})

NEGATIVE_WORDS = frozenset({
    "bad", "terrible", "awful", "horrible", "hate", "worst",
    "sad", "angry", "poor", "wrong", "broken", "ugly",
    "差", "糟", "烂", "讨厌", "失败", "错", "坏",
})
