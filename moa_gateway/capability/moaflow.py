...
SYCOPHANCY_PATTERNS: Dict[str, List[str]] = {
    "agreement_pre": [
        ...
        "that's a brilliant insight", "i see your point",
        "you're right that", "indeed", "absolutely",
    ],
    "validation_boost": [
        "as you mentioned", "building on your point", "to your point",
        "you've highlighted", "you've raised", "your insight about",
        "your observation is", "your point about",
    ],
    "hedge_to_agree": [
        "although you raised", "while you mention", "i might add to your point",
        "i would add to that", "extending your thought",
    ],
    "self_diminish": [
        "i may be wrong but", "i might be missing something",
        "i could be wrong", "perhaps naively", "maybe i'm wrong",
        "forgive me if", "correct me if i'm wrong",
    ],
    "emote": [
        "love this", "wonderful", "amazing", "fantastic",
        "brilliant", "impressive", "incredible",
    ],
    "flattery_explicit": [
        "you're smarter than", "you have a sharp eye", "your expertise",
        "your deep knowledge", "your experience shows",
    ],
    "ease_signal": [
        "sure,", "of course,", "easily", "trivially", "obviously",
        "clearly,", "no doubt",
    ],
    "moves_toward_consensus": [
        "we all agree", "everyone here", "the consensus seems",
        "it's clear that", "obviously then", "settled then",
    ],
}
...
def group_think_verdict(
    ...
    if conformity.drift_score >= 0.3:
        reasons.append(f"drift detected: {conformity.drift_score:.2f} ({len(conformity.drifters)} drifters)")
    # 检测有 mover 的 member
    if rounds and len(rounds) >= 2:
